...
function ChannelView() {
  ...
  const handleVideoSubmit = async (e) => {
    ...
    try {
      console.log("channelId", channelData.channel.channelName);
  ...
  const deleteVideo = async (videoId) => {
    ...
    try {
      console.log("trying to delete the channel...");
      await axios.delete(url, { headers: { access_token: `${token}` } }); // Sends request to delete
      console.log("was trying to delete the channel...");
        ...
        <p>
          ...
          {channelData && (
            <span className="font-bold">
              {channelData.channel.owner.username}
            </span>
          )}
        </p>
        <button
            ...
            <div className="flex justify-between items-center">
              <div className="flex flex-col items-center mt-4 px-4">
                {/* {profileImage ? (
                  ...
                  <div className="rounded-full w-10 h-10 bg-gray-200 flex justify-center items-center -mt-12">
